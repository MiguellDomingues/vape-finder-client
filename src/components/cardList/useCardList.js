...
function useCardList(products, selected_filters, fetchMore, setAndRefetch, loading,last_product_id, setLPID ) {

  console.log("////usecardlist: ", selected_filters)

  console.log("///last product id from useRef", last_product_id)
  ...
  const handleBottom = () =>{
    ...
    if(products.length%PAGE_LIMIT === 0 && last_product_id.current !== lpid){
